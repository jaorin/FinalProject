...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <!-- Column -->
        <div class="col-md-6 col-lg-3">
        <a class="" href="/checkout" aria-expanded="false">
            <div class="card card-hover">
                <div class="box bg-danger text-center">
                    <h1 class="font-light text-white">
                        <i class="mdi mdi-account-off"></i>
                    </h1>
                    <h6 class="text-white">ข้อมูลแจ้งย้ายออก</h6>
                </div>
            </div>
        </div>
        </a>
    ...
    @if( Auth::user()->role_id != '1')
    <div class="col-md-6 col-lg-3">
        <a class="" href="/payment/" aria-expanded="false">
            <div class="card card-hover">
                <div class="box bg-cyan text-center">
                    <h1 class="font-light text-white">
                ...
                <div class="card-body">
                    ...
                    <div class="todo-widget scrollable" style="height: 450px">
                        ...
                        &nbsp;&nbsp;ปัจจัย 4 ประกอบด้วย ยารักษาโรค เครื่องนุ่งห่ม อาหาร และที่อยู่อาศัย
                            ...
                            เพื่อให้บริการแก่พนักงานและนักศึกษาที่ต้องการ โดยมีทั้งหอพักที่เป็นหอพักหญิงล้วน ห้องแอร์
                            ห้องพัดลม มีบริการอินเตอร์เน็ต ซักรีด และบริการอื่นๆ อีกมากมายไว้บริการแก่ผู้ที่มาเช่า
                        </p>
                        <h6 class="mt-1 text-align-justify">
                         &nbsp;&nbsp;หอพักอยู่เจริญ ตั้งอยู่เลขที่ 348 หมู่ 2 ต.สามเรือน อ.บางปะอิน จ.พระนครศรีอยุธยา
                            รหัสไปรษณีย์ 13160 มีเนื้อที่ 145 ตารางวา สร้างขึ้นเมื่อปี พ.ศ. 2548 มีลักษณะเป็นอาคารปูน
                        ...
                        <h4 class="mt-3">1 เพื่อวิเคราะห์และออกแบบระบบจัดการหอพักโดยใช้ Web Application</h7>
                            <h4 class="mt-2">2 เพื่อให้เกิดความสะดวกและรวดเร็วในการให้บริการแก่ผู้เช่า</h7>
                                <h4 class="mt-2">3 เพื่อให้สามารถตรวจสอบข้อผิดพลาดของการคำนวณค่าเช่ารวมทั้งค่าน้ำค่าไฟ
                                    </h7>
                    </div>
                </div>
            </div>
