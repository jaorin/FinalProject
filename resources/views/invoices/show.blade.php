                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-end">
                        <address>
                            ...
                            <h6 class="font-bold">ทำสัญญาเมื่อวันที่ {{ \Carbon\Carbon::parse($invoice->leases->DateLease)->locale('th')->translatedFormat('j F Y') }}</h6>
                            <p class="mt-4">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-end"> - </td>
                                <td class="text-end">{{ number_format($invoice->Room_Price, 2) }}</td>
                                <td class="text-end">{{ number_format($invoice->Room_Price, 2) }} บาท</td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-end">{{ number_format($invoice->Water_Total, 2) }} บาท</td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-end">{{ number_format($invoice->Electricity_Total, 2) }} บาท</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-end">-</td>
                                <td class="text-end">-</td>
                                <td class="text-end">เกินกำหนดทั้งหมด : {{ $invoice->Delay_Date }} วัน </td>
                                <td class="text-end">{{ number_format($invoice->Delay_Price, 2) }} บาท</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div class="mt-4 text-end">
                    <h3><b>รวมจ่ายสุทธิ : </b>{{ number_format($invoice->Net_Pay, 2) }} บาท</h3>
                </div>
                @else
                <!-- กรณีไม่พบใบแจ้งหนี้ -->
